...
//                    if (count.get() == 1) {
//                        AssertJUnit.assertArrayEquals(new Object[]{6, 2.2, 4, 1}, inEvents[0]
//                                .getData());
//                    }
//                    if (count.get() == 6) {
//                        AssertJUnit.assertArrayEquals(new Object[]{4.8, 3.4, 1.9, 0.2}, inEvents[0]
//                                .getData());
//                    }
//                    if (count.get() == 7) {
//                        AssertJUnit.assertArrayEquals(new Object[]{5.8, 2.7, 4.1, 1}, inEvents[0]
//                                .getData());
//                    }
//                }
//            });
